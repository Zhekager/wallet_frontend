...
export const fetchTransRequest = createAction(
    'transaction/fetchTransRequest');
export const fetchTransSuccess = createAction(
    'transaction/fetchTransSuccess');
export const fetchTransError = createAction(
    'transaction/fetchTransError');


export const addTransRequest = createAction(
    'transaction/addTransRequest');
export const addTransSuccess = createAction(
    'transaction/addTransSuccess');
export const addTransError = createAction(
    'transaction/addTransError');
...
export const deleteTransError = createAction(
    'transaction/deleteTransError');
...
export const updateTransError = createAction(
    'transaction/updateTransError');
...
export const filterTransError = createAction(
